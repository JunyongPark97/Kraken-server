...
from collector.loader import load_credential
...
SECRET_KEY = '+!eh#++^w*tiut5=4kbt#%s=dqpdaal0)g49hfv-c@k80uk76a'
...
STATICFILES_STORAGE = 'collector.storage.StaticStorage'

MEDIA_LOCATION = 'media'
MEDIA_URL = "https://%s/%s/" % (AWS_S3_HOST, MEDIA_LOCATION)

DEFAULT_FILE_STORAGE = 'collector.storage.CustomS3Boto3Storage'
